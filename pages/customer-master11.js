...
const CustomerMaster11 = () => {
  ...
  return (
    <div className="relative bg-neutral-1 w-full overflow-hidden flex flex-row items-start justify-start text-left text-base text-lightmode-primary-black font-cta-14-bold">
      ...
      <div className="flex-1 h-[768px] overflow-hidden flex flex-col items-center justify-start relative gap-[30px]">
...
export default CustomerMaster11;
